            ...
            <div className="space-y-8">
              ...
              >
                <div className="glass-feature-card rounded-xl p-6 transition-all duration-300 hover:scale-[1.02]">
                  ...
                  <p className="text-gray-300 text-sm leading-relaxed">
                    Discover ideal job opportunities based on your current skills and experience. AI-powered compatibility matching shows you roles you can realistically target today.
                  </p>
                </div>
              </motion.div>
            </div>
