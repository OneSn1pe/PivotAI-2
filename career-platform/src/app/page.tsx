    ...
    <div className="fixed inset-0 z-[10000] bg-black/50 flex items-center justify-center px-4 animate-fadeIn">
      <div className="bg-white rounded-2xl shadow-2xl p-8 max-w-md w-full transform scale-100 animate-slideUp">
        ...
        <button
          ...
          className="mt-6 w-full bg-gray-900 hover:bg-gray-800 text-white font-light py-3 px-6 rounded-lg transition-all duration-300 hover-lift hover:shadow-lg hover:scale-105"
        >
          Got it
        </button>
      </div>
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 overflow-hidden">
            ...
            <div className="mb-12 p-4 sm:p-6 bg-gradient-to-r from-[#1E293B] to-[#334155] rounded-2xl shadow-xl max-w-2xl mx-auto">
              ...
              <div className="grid grid-cols-4 gap-2 sm:gap-4 max-w-md mx-auto">
                <div className="text-center">
                  <div className="bg-white/10 backdrop-blur-sm rounded-lg p-2 sm:p-3 border border-white/20 hover-lift transition-all duration-300 hover:bg-white/20 hover:border-white/40 group">
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              <div className="relative">
                <input
                  ...
                  className="w-full px-6 py-4 text-base border border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-gray-900 focus:border-transparent transition-all bg-white font-light hover:border-gray-400 hover:shadow-lg"
                  required
                  disabled={loading}
                />
                {error && (
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-gray-900 hover:bg-gray-800 text-white font-light py-4 px-8 rounded-lg transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed btn-3d btn-hover-slide relative overflow-hidden hover:shadow-xl hover:scale-105"
              >
                {loading ? (
        ...
        <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 animate-bounce hover-float group cursor-pointer">
          <div className="p-3 rounded-full transition-all duration-300 hover:bg-gray-100">
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              >
                <div className="h-full bg-white rounded-xl p-6 border border-gray-100 hover:border-gray-200 hover:shadow-lg transition-all duration-300 card-hover-tilt group hover:bg-gray-50">
                  <div className={`w-12 h-12 ${feature.color} rounded-lg flex items-center justify-center mb-4 icon-hover-bounce group-hover:scale-110 transition-transform`}>
                    <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d={feature.icon} />
                    </svg>
                  </div>
                  <h3 className="font-medium text-gray-900 mb-2 text-lg group-hover:text-blue-600 transition-colors">{feature.title}</h3>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col md:flex-row items-center justify-center gap-12 md:gap-16">
            <div className="scroll-animate opacity-0 group" style={{ animationDelay: '100ms' }}>
              <div className="w-48 h-48 bg-white rounded-lg shadow-sm p-8 flex items-center justify-center relative overflow-hidden hover-lift hover:shadow-xl hover:border-2 hover:border-blue-200 transition-all duration-300">
              ...
              <p className="mt-4 text-sm text-gray-600 font-light group-hover:text-blue-600 transition-colors">Georgia Tech</p>
            </div>
            
            <div className="scroll-animate opacity-0 group" style={{ animationDelay: '200ms' }}>
              <div className="w-48 h-48 bg-white rounded-lg shadow-sm p-8 flex items-center justify-center relative overflow-hidden hover-lift hover:shadow-xl hover:border-2 hover:border-red-200 transition-all duration-300">
              ...
              <p className="mt-4 text-sm text-gray-600 font-light group-hover:text-red-600 transition-colors">University of Wisconsin-Madison</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center">
            ...
            <div className="flex justify-center items-center gap-6">
              ...
              >
                <div className="w-12 h-12 bg-white rounded-lg border border-gray-200 flex items-center justify-center transition-all duration-300 hover:bg-[#0077B5] hover:border-[#0077B5] hover:shadow-md hover-lift group-hover:scale-110">
              ...
              >
                <div className="w-12 h-12 bg-white rounded-lg border border-gray-200 flex items-center justify-center transition-all duration-300 hover:bg-[#FF0000] hover:border-[#FF0000] hover:shadow-md hover-lift group-hover:scale-110">
                  <svg className="w-5 h-5 text-gray-600 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
              ...
              >
                <div className="w-12 h-12 bg-white rounded-lg border border-gray-200 flex items-center justify-center transition-all duration-300 hover:bg-[#E4405F] hover:border-[#E4405F] hover:shadow-md hover-lift group-hover:scale-110">
                  <svg className="w-5 h-5 text-gray-600 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
              ...
              >
                <div className="w-12 h-12 bg-white rounded-lg border border-gray-200 flex items-center justify-center transition-all duration-300 hover:bg-gray-900 hover:border-gray-900 hover:shadow-md hover-lift group-hover:scale-110">
                  <svg className="w-5 h-5 text-gray-600 group-hover:text-white transition-colors" fill="currentColor" viewBox="0 0 24 24">
